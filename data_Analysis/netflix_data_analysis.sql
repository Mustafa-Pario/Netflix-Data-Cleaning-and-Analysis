...
--new table for listed in, directores, country, cast
...
into netflix_directores
from netflix_raw
cross apply string_split(director, ',')

select * from netflix_directores;
...
inner join netflix_directores nd
...
select director,country
from  netflix_country nc
inner join netflix_directores nd on nc.show_id=nd.show_id
group by director,country
...
from netflix n
inner join netflix_directores nd on n.show_id=nd.show_id
...
(select show_id from netflix_directores where director='Steve Brill')
order by genre
